                ...
                <div class="slider-item" style="background-color:#3D3D3D;">
                    <div class="container">
                        <div class="slider-item-inner">
                            ...
                            <img class="slider-item-img-right" src="img/test_slider/14.png" alt="Image Alternative text" title="Image Title" style="top: 60%; width: 56%;" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="slider-item" style="background-image:url(img/1200xx500.jpg);">
                    <div class="container">
                        <div class="slider-item-inner">
                            ...
                            <img class="slider-item-img-left" src="img/test_slider/1.png" alt="Image Alternative text" title="Image Title" style="transform:translateY(-50%) rotate(14deg); width: 55%;" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="slider-item" style="background-color:#93282B;">
                    <div class="container">
                        <div class="slider-item-inner">
                            ...
                            <img class="slider-item-img-right" src="img/test_slider/6.png" alt="Image Alternative text" title="Image Title" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" data-gutter="15">
                <div class="col-md-4">
                    <div class="banner" style="background-color:#72121C;">
                        ...
                        <img class="banner-img" src="img/test_slider/3.png" alt="Image Alternative text" title="Image Title" style="bottom: 5px; right: -20px;" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner" style="background-color:#4172FF;">
                        ...
                        <img class="banner-img" src="img/test_slider/17.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px;  right: 1px; "  />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="banner" style="background-color:#444C50;">
                        ...
                        <img class="banner-img" src="img/test_slider/13.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -10px; width: 250px;" />
                    </div>
                </div>
            </div>
            <div class="gap"></div>
                ...
                <div class="col-md-3">
                    <div class="product ">
                        ...
                        <div class="product-caption">
                            ...
                            <div class="product-caption-price"><span class="product-caption-price-new">$31</span>
                            </div>
                        </div>
                    </div>
                </div>
